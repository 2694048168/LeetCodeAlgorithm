...
"""
@Filename: findLadders.py
@Function: 单词接龙 II 广度优先搜索
...
if __name__ == "__main__":
    ...
    solution = Solution()
    ladder_vec = solution.findLadders(beginWord, endWord, wordList)
    print(f"The solutio of this problem is : {ladder_vec}")
